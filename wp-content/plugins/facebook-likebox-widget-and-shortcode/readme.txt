...
Tags: facebook, facebook likebox, facebook widget, facebook plugin for wordpress, facebook profile
...
Facebook Likebox, Facebook Widget, Facebook Mini Profile , Facebook Likebox Widget & Shortcode Plugin For WordPress

== Description ==

= Facebook Likebox, Facebook Widget, Facebook Mini Profile =

A very easy and simple Facebook Likebox Widget & Shortcode Plugin for WordPress blog sites.

You can promote any facebook page with facebook Likebox and facebook Likebox is also responsive so you can use it on any page and post.

You can attract visitor to your facebook page with face book like box and also you can convert your site trafic to your facebook page.
...
The number of displayed Facebook feeds per each post/page is unlimited. You can add Facebook feeds based on different pages, groups and profile  within the same page. For Facebook pages and Facebook groups you can choose the user roles whose posts will be shared- page owner/ group admin, group member/page fans or both. Hashtags and mentions included in posts will be preserved. Facebook albums will be displayed with thumbnails which open up in lightbox. High-resolution lightbox images will be accompanied with filmstrip which will turn the standard display of images into an elegant Facebook gallery. The Facebook page plugin comes with a number of great features and functionality to allow you create anything from free simple feeds to custom feeds, including Facebook group events, Facebook likebox, Facebook feed gallery and more to increase engagement of your Facebook fans.
...
* [Flickr Gallery](https://wordpress.org/plugins/wp-flickr-gallery/ "Awesome Flickr Gallery") - The Gallery Plugin to create awesome Flickr Album And Photostream Gallery. 

**Buy Premium Plugin - <a href="http://awplife.com/product/flickr-gallery-premium/">Click Here</a>**

* [Event Manager](https://wordpress.org/plugins/event-monster/ "perfect Event Manager") - This plugin is use to create events.  

**Buy Premium Plugin - <a href="http://awplife.com/product/event-monster-premium/">Click Here</a>**
...
* Bug Fix: None
* Additional changes: Yes, Theme page added.

Feature Enhancements: 0.5.2
* Enhancements: None
* Bug Fix: None
* Additional changes: None

Feature Enhancements: 0.5.1
* Enhancements: None
* Bug Fix: None
* Additional changes: None

Feature Enhancements: 0.5.0
* Enhancements: None
* Bug Fix: None
* Additional changes: None

Feature Enhancements: Version 0.4.10
* Additional changes: Compatible up to WordPress new version 4.8
* Bug fix: None
