...
if ( ! class_exists( 'Fb_Likebox_Shortcode_CPT' ) ) {
	...
	class Fb_Likebox_Shortcode_CPT {
		...
		public function _fb_likebox_doc_menu() {
			...
			$theme_menu    = add_submenu_page( 'edit.php?post_type='.FLWS_PLUGIN_SLUG, __( 'Our Theme', 'fblike_txt_dm' ), __( 'Our Theme', 'fblike_txt_dm' ), 'administrator', 'sr-theme-page', array( $this, '_fb_theme_page') );
		}		
